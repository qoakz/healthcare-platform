...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@healthcareplatform.com')
...
SENDGRID_FROM_EMAIL = config('SENDGRID_FROM_EMAIL', default='noreply@healthcareplatform.com')
...
WEBRTC_TURN_SERVERS = [
    {
        'urls': config('TURN_SERVER_URL', default='turn:localhost:3478'),
        'username': config('TURN_USERNAME', default='healthcare'),
        'credential': config('TURN_PASSWORD', default='healthcare123'),
    }
]
